...
Write-AlpacaDebug "Set environmental variable 'ALPACA_BACKEND_URL' to '$backendUrl'"
...
if ((Get-IsAlpacaContainerRequired -Settings $Settings)) {
    ...
    $containers = @(Get-AlpacaContainer -Project $project -Token $env:_token -BuildMode $BuildMode)
