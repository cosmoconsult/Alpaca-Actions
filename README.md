...
| [Initialization](Actions/Initialization) | Initialize COSMO Alpaca backend connection and configuration |
| [Remove Containers](Actions/RemoveContainers) | Remove COSMO Alpaca containers |
| [Sync Secrets](Actions/SyncSecrets) | Sync secrets to the Alpaca backend for development containers |
